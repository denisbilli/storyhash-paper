...
% Clean two-column LaTeX source (main_two_column.tex)
% Author: Denis Billi
% Date: November 2025
...
% microtype sometimes requires scalable fonts; omit in minimal BasicTeX test build
...
% provide text degree symbol and a simple \degree macro
\usepackage{textcomp}
...
% Bibliography (use the repository references.bib)
